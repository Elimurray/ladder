...
function SubmitMatchForm() {
    ...
    const fetchMatch = async () => {
        try {
            ...
            const pendingResults = await matchesAPI.getPending();
            const existingSubmission = pendingResults.data.find(
                m => m.player1_match_id && m.player2_match_id &&
                    (m.player1_id === matchData.player1_id || m.player1_id === matchData.player2_id)
            );
    ...
    const handleSubmit = async (e) => {
        ...
        const playerId = submittingFor === "player1" ? match.player1_id : match.player2_id;
        const opponentId = submittingFor === "player1" ? match.player2_id : match.player1_id;
    ...
    const handleDefaulted = async () => {
        ...
        if (!confirm(`Are you sure ${submittingFor === "player1" ? match.player1_name : match.player2_name} defaulted?`)) return;
    ...
    if (error && !match) return <div className="page"><div className="error">{error}</div></div>;
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ textAlign: "center" }}>
                                <div style={{ fontSize: "0.875rem", opacity: 0.8 }}>Player 1</div>
                            ...
                            <div style={{ textAlign: "center" }}>
                                <div style={{ fontSize: "0.875rem", opacity: 0.8 }}>Player 2</div>
                                <div style={{ fontWeight: "bold", fontSize: "1.25rem", marginTop: "0.5rem" }}>
                        ...
                        {match.time_slot && (
                            <div style={{ marginTop: "1rem", textAlign: "center", paddingTop: "1rem", borderTop: "1px solid #e2e8f0" }}>
                                🕐 {match.time_slot}
                            </div>
                        )}
                    </div>
                        ...
                        <>
                            ...
                            <form onSubmit={handleSubmit} className="match-form">
                                <div className="form-group">
                                    ...
                                    <select
                                        value={gamesWon}
                                        onChange={(e) => handleGamesChange(e.target.value, gamesLost)}
                                        required
                                    >
                                ...
                                <div className="form-group">
                                    ...
                                    <select
                                        value={gamesLost}
                                        onChange={(e) => handleGamesChange(gamesWon, e.target.value)}
                                        required
                                    >
                                        <option value="">-- Select --</option>
                                        <option value="0">0</option>
                            ...
                            <div style={{ marginTop: "2rem", paddingTop: "2rem", borderTop: "2px solid #e2e8f0" }}>
                                ...
                                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                                    <button onClick={handleDidNotPlay} style={{
                                        padding: "0.75rem 1.5rem",
                                        background: "#718096",
                                        color: "white",
                                        border: "none",
                                    ...
                                    <button onClick={handleDefaulted} style={{
                                        padding: "0.75rem 1.5rem",
                                        background: "#e53e3e",
                                        color: "white",
                                        border: "none",
