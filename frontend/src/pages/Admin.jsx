                      ...
                      onClick={async () => {
                        try {
                          ...
                          if (isPublished) {
                            ...
                            showSuccess(
                              "Draw published - now visible to users!",
                            );
                          }
                          fetchDrawByDate(selectedDrawDate);
                        } catch (err) {
                  ...
                  >
                    ...
                    <form onSubmit={handleCreateMatch}>
                      ...
                      >
                        ...
                        <div className="form-group" style={{ marginBottom: 0 }}>
                          <label>
                            Player 2 (optional - leave empty for BYE):
                          </label>
                          <select
                        ...
                        <div className="form-group" style={{ marginBottom: 0 }}>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setNewMatchTimeSlot(e.target.value)
                            }
                            style={{
                              width: "100%",
                              padding: "0.75rem",
                          ...
                          >
                            ...
                            <span
                              style={{
                                fontSize: "1.25rem",
                                fontWeight: "bold",
                                color: match.scores_match
                                  ? "#48bb78"
                                  : "#e53e3e",
                              }}
                            >
                              {match.player1_games_won} -{" "}
                              {match.player1_games_lost}
                            </span>
                            <strong style={{ fontSize: "1rem" }}>
                              {match.player2_name}
                            </strong>
