...
\restrict FzUSGCi2EDxNeiySk4cT9R4ie43ziOZaMRhSZ0JNA6JrhEzdCmAzjU2ucao68tE
...
--
-- Name: live_match_events; Type: TABLE; Schema: public; Owner: eli
--

CREATE TABLE public.live_match_events (
    id integer NOT NULL,
    live_match_id integer NOT NULL,
    event_number integer NOT NULL,
    point_to integer NOT NULL,
    created_by integer,
    created_at timestamp without time zone DEFAULT now(),
    CONSTRAINT live_match_events_point_to_check CHECK ((point_to = ANY (ARRAY[1, 2])))
);


ALTER TABLE public.live_match_events OWNER TO eli;

--
-- Name: live_match_events_id_seq; Type: SEQUENCE; Schema: public; Owner: eli
--

CREATE SEQUENCE public.live_match_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.live_match_events_id_seq OWNER TO eli;

--
-- Name: live_match_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: eli
--

ALTER SEQUENCE public.live_match_events_id_seq OWNED BY public.live_match_events.id;


--
-- Name: live_matches; Type: TABLE; Schema: public; Owner: eli
--
...
CREATE TABLE public.live_matches (
    ...
    current_score jsonb DEFAULT '{"sets_won": {"p1": 0, "p2": 0}, "current_set": {"p1": 0, "p2": 0}, "completed_sets": []}'::jsonb NOT NULL,
    match_id integer,
    started_at timestamp without time zone DEFAULT now() NOT NULL,
    ended_at timestamp without time zone,
    CONSTRAINT live_matches_best_of_check CHECK ((best_of = ANY (ARRAY[3, 5]))),
    CONSTRAINT live_matches_status_check CHECK (((status)::text = ANY ((ARRAY['live'::character varying, 'completed'::character varying, 'abandoned'::character varying])::text[])))
);


ALTER TABLE public.live_matches OWNER TO eli;

--
-- Name: live_matches_id_seq; Type: SEQUENCE; Schema: public; Owner: eli
--
...
ALTER TABLE public.live_matches_id_seq OWNER TO eli;

--
-- Name: live_matches_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: eli
--
...
--
-- Name: live_match_events id; Type: DEFAULT; Schema: public; Owner: eli
--

ALTER TABLE ONLY public.live_match_events ALTER COLUMN id SET DEFAULT nextval('public.live_match_events_id_seq'::regclass);


--
-- Name: live_matches id; Type: DEFAULT; Schema: public; Owner: eli
--
...
--
-- Name: live_match_events live_match_events_live_match_id_event_number_key; Type: CONSTRAINT; Schema: public; Owner: eli
--

ALTER TABLE ONLY public.live_match_events
    ADD CONSTRAINT live_match_events_live_match_id_event_number_key UNIQUE (live_match_id, event_number);


--
-- Name: live_match_events live_match_events_pkey; Type: CONSTRAINT; Schema: public; Owner: eli
--
...
--
-- Name: live_matches live_matches_pkey; Type: CONSTRAINT; Schema: public; Owner: eli
--
...
--
-- Name: idx_live_matches_draw; Type: INDEX; Schema: public; Owner: eli
--

CREATE INDEX idx_live_matches_draw ON public.live_matches USING btree (draw_id);


--
-- Name: idx_live_matches_one_live_per_draw; Type: INDEX; Schema: public; Owner: eli
--

CREATE UNIQUE INDEX idx_live_matches_one_live_per_draw ON public.live_matches USING btree (draw_id) WHERE ((status)::text = 'live'::text);


--
-- Name: idx_live_matches_one_live_per_ref; Type: INDEX; Schema: public; Owner: eli
--

CREATE UNIQUE INDEX idx_live_matches_one_live_per_ref ON public.live_matches USING btree (ref_user_id) WHERE ((status)::text = 'live'::text);
...
--
-- Name: live_match_events live_match_events_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: eli
--

ALTER TABLE ONLY public.live_match_events
    ADD CONSTRAINT live_match_events_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: live_match_events live_match_events_live_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: eli
--

ALTER TABLE ONLY public.live_match_events
    ADD CONSTRAINT live_match_events_live_match_id_fkey FOREIGN KEY (live_match_id) REFERENCES public.live_matches(id) ON DELETE CASCADE;


--
-- Name: live_matches live_matches_draw_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: eli
--

ALTER TABLE ONLY public.live_matches
    ADD CONSTRAINT live_matches_draw_id_fkey FOREIGN KEY (draw_id) REFERENCES public.draws(id);


--
-- Name: live_matches live_matches_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: eli
--
...
--
-- Name: live_matches live_matches_ref_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: eli
--

ALTER TABLE ONLY public.live_matches
    ADD CONSTRAINT live_matches_ref_user_id_fkey FOREIGN KEY (ref_user_id) REFERENCES public.users(id);
...
\unrestrict FzUSGCi2EDxNeiySk4cT9R4ie43ziOZaMRhSZ0JNA6JrhEzdCmAzjU2ucao68tE
